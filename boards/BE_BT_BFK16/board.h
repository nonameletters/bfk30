 ...
 * Board identifier.
 */
#if !defined(BOARD_BE_BT_BFK16) && !defined(BOARD_BE_BT_BFK20)
#define BOARD_BE_BT_BFK16
#endif
...
#define VAL_GPIOB_MODER             (PIN_MODE_ALTERNATE(3)    | \
                                     ...
                                     PIN_MODE_OUTPUT(14)   | \
                                     PIN_MODE_OUTPUT(15))
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_OPENDRAIN(5)  | \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_2M(5)      |           \
                                     PIN_OSPEED_2M(6)      |           \
                                     PIN_OSPEED_2M(7)      |           \
                                     PIN_OSPEED_2M(10)     |           \
                                     PIN_OSPEED_2M(11)     |           \
...
#define VAL_GPIOC_PUPDR             (PIN_PUDR_FLOATING(5)     | \
                                     PIN_PUDR_FLOATING(6)     | \
                                     PIN_PUDR_PULLUP(7)     |          \
                                     PIN_PUDR_FLOATING(9)     | \
                                     PIN_PUDR_FLOATING(12)    | \
...
#define VAL_GPIOD_OTYPER            (PIN_OTYPE_OPENDRAIN(2))
#define VAL_GPIOD_OSPEEDR           (PIN_OSPEED_2M(2))
