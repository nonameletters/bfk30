...
/* === Generic functions === */
int spi_write_status_enable(sFLASH_USBDriver *flash)
{
...
static int spi_write_status_register_flag(sFLASH_USBDriver *flash, int status, const unsigned char enable_opcode)
{
	int result;
	int i = 0;
	/*
 ...
 */
static int spi_disable_blockprotect_generic(sFLASH_USBDriver *flash, uint8_t bp_mask, uint8_t lock_mask, uint8_t wp_mask, uint8_t unprotect_mask)
{
	uint8_t status;
	int result;
